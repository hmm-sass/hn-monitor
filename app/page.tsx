    ...
    <>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .hero::before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse 80% 60% at 20% 20%,rgba(255,77,0,0.08) 0%,transparent 60%),radial-gradient(ellipse 60% 80% at 80% 80%,rgba(0,102,255,0.06) 0%,transparent 60%);pointer-events:none;}
        .hero-badge{display:inline-flex;align-items:center;gap:8px;background:var(--surface);border:1px solid var(--border);border-radius:100px;padding:6px 16px 6px 8px;font-size:13px;color:var(--ink-2);margin-bottom:40px;box-shadow:0 2px 8px rgba(0,0,0,0.06);}
        .badge-dot{width:8px;height:8px;background:var(--green);border-radius:50%;animation:blink 2s infinite;}
        @keyframes blink{0%,100%{opacity:1;}50%{opacity:0.3;}}
        .hero h1{font-family:'Instrument Serif',serif;font-size:clamp(52px,8vw,96px);line-height:1.0;letter-spacing:-2px;margin-bottom:24px;}
        .hero h1 em{font-style:italic;color:var(--orange);}
        .hero-sub{font-size:clamp(16px,2vw,20px);color:var(--ink-2);max-width:560px;line-height:1.7;margin-bottom:48px;font-weight:300;}
        ...
        .btn-ghost{font-size:15px;font-weight:400;padding:14px 32px;color:var(--ink-2);text-decoration:none;border-radius:100px;border:1px solid var(--border);transition:all 0.25s;background:var(--surface);}
        .btn-ghost:hover{border-color:var(--ink);color:var(--ink);transform:translateY(-2px);}
        .hero-card{margin-top:80px;max-width:640px;width:100%;}
        .slack-preview{background:#1a1d21;border-radius:16px;padding:24px;text-align:left;box-shadow:0 32px 80px rgba(0,0,0,0.18);position:relative;overflow:hidden;}
        .slack-preview::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,var(--orange),#ff9500,var(--blue));}
        ...
        .sp-alert{background:rgba(255,77,0,0.12);border:1px solid rgba(255,77,0,0.3);border-radius:8px;padding:12px 16px;margin-bottom:12px;}
        .sp-alert-title{font-size:13px;font-weight:600;color:#ff7043;margin-bottom:4px;}
        ...
        .score-chip-val{font-size:22px;font-weight:700;color:#fff;}
        .score-chip-val.danger{color:var(--orange);}
        .score-chip-val.viral{color:#ffb300;}
        .sp-reply{background:rgba(0,102,255,0.08);border-left:2px solid var(--blue);border-radius:0 6px 6px 0;padding:12px 14px;margin-top:12px;font-size:13px;color:rgba(255,255,255,0.6);line-height:1.6;font-style:italic;}
        ...
        .features-section{padding:120px 40px;max-width:1100px;margin:0 auto;}
        ...
        .section-title{font-family:'Instrument Serif',serif;font-size:clamp(36px,5vw,56px);letter-spacing:-1.5px;line-height:1.1;margin-bottom:64px;color:var(--ink);}
        ...
        .step-num{font-family:'Instrument Serif',serif;font-size:72px;color:rgba(255,255,255,0.06);line-height:1;margin-bottom:16px;letter-spacing:-3px;}
        ...
        .plan-features li{font-size:14px;color:var(--ink-2);padding:8px 0;display:flex;align-items:center;gap:10px;font-weight:300;}
        .plan.featured .plan-features li{color:rgba(255,255,255,0.65);}
        .plan-features li::before{content:'✓';color:var(--green);font-weight:600;font-size:13px;flex-shrink:0;}
        ...
        .plan.featured .plan-cta:hover{background:#ff6a1a;transform:translateY(-1px);box-shadow:0 8px 24px rgba(255,77,0,0.4);}
        ...
        <div className="hero-card" id="demo">
          <div className="slack-preview">
            ...
            <div className="sp-scores">
              <div className="score-chip"><div className="score-chip-label">Risk Score</div><div className="score-chip-val danger">9/10</div></div>
              <div className="score-chip"><div className="score-chip-label">Viral Score</div><div className="score-chip-val viral">8/10</div></div>
              <div className="score-chip"><div className="score-chip-label">Upvotes</div><div className="score-chip-val">120</div></div>
            </div>
      ...
      <div className="stats">
        {[["5min","Early detection"],["9/10","Risk scoring"],["< 30s","Reply drafted"],["$0","To get started"]].map(([num,label])=>(
      ...
      <section className="features-section" id="features">
        ...
        <h2 className="section-title">Everything you need<br/>to <em>stay ahead.</em></h2>
        <div className="features-grid">
          {[
            ["🚨","Risk Score (1–10)","Know instantly if a post threatens your brand. Score 8+ triggers an immediate Slack alert."],
            ["📈","Viral Score (1–10)","Predict if a post will blow up before it does. Catch opportunity threads early."],
            ["💬","HN-Style Reply Draft","AI writes in authentic founder tone. Paste and send in seconds."],
            ["⚡","5-Min Early Detection","Catch threads before they gain momentum. The first 30 minutes are everything."],
            ["🥊","Competitor Radar","Monitor what HN says about your competitors. Turn their bad press into your win."],
      ...
      <section className="how-section">
        <div className="how-inner">
          ...
          <h2 className="section-title">Up and running<br/><em>in 2 minutes.</em></h2>
          <div className="steps">
            {[
